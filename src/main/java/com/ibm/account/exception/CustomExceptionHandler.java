...
import com.ibm.account.services.*;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ibm.account.exception.Error.SeverityEnum;
...
public class CustomExceptionHandler {
	...
	//#AutowireServices
	@Autowired
	private GetAccountsUsingGETI getAccountsUsingGETI;
	@Autowired
	private GetAccountUsingGETI getAccountUsingGETI;
	@Autowired
	private ErrorHtmlUsingGETI errorHtmlUsingGETI;
	@Autowired
	private ErrorHtmlUsingPUTI errorHtmlUsingPUTI;
	@Autowired
	private ErrorHtmlUsingPOSTI errorHtmlUsingPOSTI;
	@Autowired
	private ErrorHtmlUsingDELETEI errorHtmlUsingDELETEI;
	@Autowired
	private ErrorHtmlUsingPATCHI errorHtmlUsingPATCHI;
	@Autowired
	private ErrorHtmlUsingHEADI errorHtmlUsingHEADI;
	@Autowired
	private ErrorHtmlUsingOPTIONSI errorHtmlUsingOPTIONSI;
	@Autowired
	private GetMessageUsingGETI getMessageUsingGETI;
	...
	private Object getErrorObject(String operationId,ErrorStatusCode code,Exception exception){
		...
		if(apiExceptionResponse != null) {
			try {
				switch(operationId){
			case "getAccountsUsingGET":
			object = getAccountsUsingGETI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "getAccountUsingGET":
			object = getAccountUsingGETI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingGET":
			object = errorHtmlUsingGETI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingPUT":
			object = errorHtmlUsingPUTI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingPOST":
			object = errorHtmlUsingPOSTI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingDELETE":
			object = errorHtmlUsingDELETEI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingPATCH":
			object = errorHtmlUsingPATCHI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingHEAD":
			object = errorHtmlUsingHEADI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "errorHtmlUsingOPTIONS":
			object = errorHtmlUsingOPTIONSI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "getMessageUsingGET":
			object = getMessageUsingGETI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
