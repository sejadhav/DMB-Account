package com.ibm.account.logging;
...
public class LoggingAspect {
	...
	@AfterReturning(pointcut = "execution(* com.ibm.account..*.*(..))", returning = "retVal")
